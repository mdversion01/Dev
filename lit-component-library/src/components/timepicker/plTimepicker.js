...
import { plInputGroupStyles } from "../pl-input-group/pl-input-group-styles";
...
class PlTimePicker extends LitElement {
    ...
    return html`
      <div class="plumage">
        <div class="time-picker-container">
          <!-- <div class="form-group form-pl-input-group"> -->
          <div class="time-picker ${!this.display24HourOnly && !this.display12HourOnly ? 'mr-2' : ''}">
            ...
            >
              <input
                ...
                maxlength="${this.is24HourFormat
                  ...
                  ? "8"
                  : "11"}"
                @focus="${this._handleFocusAndInteraction}"
                @blur="${this._handleFocusAndInteraction}"
            ...
            <div
              class="validation-message ${this.validationMessage
                ? ""
                : "hidden"}"
              role="alert"
            ...
            <div
              class="warning-message hidden"
              role="alert"
              id="warning-message"
            >
              <i class="fa fa-exclamation-triangle"></i> Time values cannot
              exceed the limits.
            </div>
  ...
  _handleDocumentClick(event) {
    const bFocusDiv = this.shadowRoot.querySelector(".b-focus");
    const isInputOrDropdownClicked =
      event.composedPath().includes(this.shadowRoot.querySelector("input")) ||
      event
        .composedPath()
        .includes(this.shadowRoot.querySelector(".time-icon-btn"));

    if (!isInputOrDropdownClicked && bFocusDiv) {
      bFocusDiv.style.width = "0";
      bFocusDiv.style.left = "50%";
    }
  }
