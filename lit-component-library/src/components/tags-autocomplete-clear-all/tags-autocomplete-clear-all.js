...
class TagsAutocompleteClearAll extends LitElement {
  constructor() {
    super();
  ...
  render() {
    return html`
      ...
      />
      <link rel="stylesheet" href="./tags-autocomplete-clear-all.css" />
  ...
  firstUpdated() {
    ...
    setTimeout(() => {
      ...
      if (tagInput && inputContainer) {
        ...
        // Function to update the suggestion dropdown based on user input
...
customElements.define("tags-autocomplete-clear-all", TagsAutocompleteClearAll);
